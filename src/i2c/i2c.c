...
void i2cInit(void) {
	...
	/* clear flags */I2C_CONCLR = 0x6c;

	/* reset registers */I2C_SCLL = (I2C_SCLL & ~I2C_REG_SCLL_MASK)
			| I2C_REG_SCLL;
...
tS8 i2cStart(void) {
	...
	/* issue a start condition */I2C_CONSET |= 0x20; /* STA = 1, set start flag */
	...
	/* clear start flag */I2C_CONCLR = 0x20;
